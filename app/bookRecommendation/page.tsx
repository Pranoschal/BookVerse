                              ...
                              <Tooltip>
                                <TooltipTrigger asChild>
                                  <motion.button
                                    ...
                                    whileTap={{ scale: 0.9 }}
                                    className="w-7 h-7 bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white rounded-full flex items-center justify-center shadow-lg transition-all duration-300"
                                  >
                                    <Plus className="w-3 h-3" />
                                  </motion.button>
                                </TooltipTrigger>
                                <TooltipContent side="left" className="z-100 bg-gradient-to-br from-purple-600/40 via-purple-500/35 to-blue-600/40">
                                  <p>Add to Library</p>
                                </TooltipContent>
                              </Tooltip>
                            </div>
